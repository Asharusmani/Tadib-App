import { StyleSheet, View, Text, TouchableOpacity, ScrollView, Modal, Animated, Platform, Alert } from "react-native";
...
// Professional Custom Toggle Component
...
const AddHabitModal = ({ visible, onClose, onSave }) => {
    ...
    const handleInviteFriends = () => {
        Alert.alert(
            '🎉 Coming Soon',
            'Invite friends feature will be available in the next update!',
                    ...
                    <View style={styles.modalHeader}>
                        <View style={styles.headerContent}>
                            ...
                            <View style={styles.headerText}>
                                ...
                                <Text style={styles.modalSubtitle}>Build better habits daily</Text>
                            </View>
                        </View>
                    ...
                    >
                            ...
                            <View style={styles.inputWrapper}>
                                ...
                                <View style={styles.input}>
                                    ...
                                    <TextInput
                                        ...
                                        placeholder="e.g., Morning Prayer, Exercise..."
                        ...
                        <View style={styles.card}>
                            <View style={styles.cardHeader}>
                                ...
                                <Text style={styles.cardTitle}>Choose Icon <Text style={styles.required}>*</Text></Text>
                            </View>
                        ...
                        <View style={styles.card}>
                            <View style={styles.cardHeader}>
                                ...
                                <Text style={styles.cardTitle}>Category <Text style={styles.required}>*</Text></Text>
                            </View>
                                ...
                                {CATEGORIES.map((cat) => (
                                    <TouchableOpacity
                                        ...
                                        style={[
                                            ...
                                            { backgroundColor: selectedCategory === cat.name ? cat.lightColor : '#F9FAFB' }
                                        ]}
                                    ...
                                    >
                                        <View style={[
                                            ...
                                            { backgroundColor: selectedCategory === cat.name ? cat.color : '#E5E7EB' }
                                        ]}>
                        ...
                        <View style={styles.card}>
                            <View style={styles.toggleSection}>
                                ...
                                <CustomToggle
                                    value={isNegativeHabit}
                                    onValueChange={handleToggleChange}
                                />
                            </View>
                        </View>

                        {/* Frequency - Card Style */}
                        <View style={styles.card}>
                            <View style={styles.cardHeader}>
                                ...
                                {['Daily', 'Weekly', 'Monthly'].map((freq) => (
                                    ...
                                    >
                                        <Ionicons
                                            name={
                                                freq === 'Daily' ? 'today' :
                                                    freq === 'Weekly' ? 'calendar-outline' :
                                                        'calendar-number'
                                            }
                                            size={20}
                                            color={selectedFrequency === freq ? '#FFF' : '#6B7280'}
                                        />
                                        <Text style={[
                        ...
                        {/* Points & Skip Days - Combined Card */}
                        <View style={styles.card}>
                            <View style={styles.cardHeader}>
                        ...
                        {/* Invite Friends - Card Style */}
                        <View style={styles.card}>
                            <View style={styles.cardHeader}>
                                <Ionicons name="people" size={18} color="#10B981" />
                                <Text style={styles.cardTitle}>Social (Optional)</Text>
                            </View>
                            <TouchableOpacity
                            ...
                            >
                                <View style={styles.inviteLeft}>
                                    ...
                                    <View>
                                        ...
                                        <Text style={styles.inviteSubtext}>Track together & stay motivated</Text>
                                    </View>
                                </View>
                                <Ionicons name="chevron-forward" size={20} color="#9CA3AF" />
                            </TouchableOpacity>
...
const styles = StyleSheet.create({
    ...
    modalContent: {
        ...
        height: "90%",          // ✅ ADD THIS
        maxHeight: "90%",       // ✅ optional but safe
        shadowColor: "#000",
        shadowOffset: {
            width: 0,
            height: -4,
